            ...
            modelBuilder.Entity("H.Modules.Identity.hi_dd_author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CDATE = new DateTime(2024, 2, 5, 14, 31, 20, 540, DateTimeKind.Local).AddTicks(9929),
                            ISENBLED = 1,
                            Name = "用户管理",
                            UDATE = new DateTime(2024, 2, 5, 14, 31, 20, 540, DateTimeKind.Local).AddTicks(9929)
                        },
                        new
                        {
                            ID = "{DE3B4992-A5BF-4AD2-80D8-2C9654C47A34}",
                            CDATE = new DateTime(2024, 2, 5, 14, 31, 20, 540, DateTimeKind.Local).AddTicks(9992),
                            ISENBLED = 1,
                            Name = "角色管理",
                            UDATE = new DateTime(2024, 2, 5, 14, 31, 20, 540, DateTimeKind.Local).AddTicks(9992)
                        });
                });
            ...
            modelBuilder.Entity("H.Modules.Identity.hi_dd_role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CDATE = new DateTime(2024, 2, 5, 14, 31, 20, 541, DateTimeKind.Local).AddTicks(36),
                            Code = "01",
                            ISENBLED = 1,
                            Name = "管理员",
                            UDATE = new DateTime(2024, 2, 5, 14, 31, 20, 541, DateTimeKind.Local).AddTicks(36)
                        },
                        new
                        {
                            ID = "{0E465AF1-4C5B-417B-B496-E74E8A0D7E5C}",
                            CDATE = new DateTime(2024, 2, 5, 14, 31, 20, 541, DateTimeKind.Local).AddTicks(59),
                            Code = "02",
                            ISENBLED = 1,
                            Name = "普通用户",
                            UDATE = new DateTime(2024, 2, 5, 14, 31, 20, 541, DateTimeKind.Local).AddTicks(59)
                        });
                });
            ...
            modelBuilder.Entity("H.Modules.Identity.hi_dd_user", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Account = "admin",
                            CDATE = new DateTime(2024, 2, 5, 14, 31, 20, 541, DateTimeKind.Local).AddTicks(70),
                            Enable = false,
                            ISENBLED = 1,
                            ...
                            UDATE = new DateTime(2024, 2, 5, 14, 31, 20, 541, DateTimeKind.Local).AddTicks(70)
                        },
                        new
                        {
                            ID = "{A8EE1331-0DA7-42F1-80E2-CD2A20D62BC9}",
                            Account = "user",
                            CDATE = new DateTime(2024, 2, 5, 14, 31, 20, 541, DateTimeKind.Local).AddTicks(86),
                            Enable = false,
                            ISENBLED = 1,
                            LastLoginTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LicenseDeadline = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            UDATE = new DateTime(2024, 2, 5, 14, 31, 20, 541, DateTimeKind.Local).AddTicks(86)
                        });
                });
